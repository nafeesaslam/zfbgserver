...
function drawTitleLogo() {
...

    {
        ...
        overlayCtx.fillText('WAR ZONE', centerX, centerY);
    }
}
...
function drawExitButton() {
    ...
    overlayCtx.fillStyle = isMouseOver ? COLOR_YELLOW : COLOR_ORANGE;
    overlayCtx.fillRect(buttonX, buttonY, buttonWidth, buttonHeight);
    
    setTextAlign(ALIGN_CENTER);
    setFontSize(16);
    drawShadowText('EXIT', centerX, buttonY + 27);
}
